...
- [ ] Clone this repo
- [ ] Create a branch `git checkout -b 'Jarrod-Skahill'`
  - [ ] Add a file to the project called `Jarrod-Skahill`.txt. This file can contain anything.
...
- [ ] Go into your project folder, make a new branch `Jarrod-Skahill`
